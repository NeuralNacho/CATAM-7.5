...
\begin{minipage}{\textwidth}
	...
	\captionof{figure}{Scatter graph showing poles of $R_{L,L}(x)$ for $f_{4}(x)$}
	\label{q5_fig1_poles}
\end{minipage}
\vspace{0.1cm}
...
\begin{minipage}{\textwidth}
	...
	\captionof{figure}{Scatter graph showing zeros of $R_{L,L}(x)$ for $f_{4}(x)$}
	\label{q5_fig1_zeros}
\end{minipage}
\vspace{0.1cm}
...
\begin{minipage}{\textwidth}
	...
	\captionof{figure}{Graph showing poles of approximants of $f_{6}(x)$}
	\label{q5_fig2}
\end{minipage}
\vspace{0.1cm}
...
\begin{minipage}{\textwidth}
	...
	\captionof{figure}{Graph with $f_{6}(x)$ and two different approximants}
	\label{q5_fig5}
\end{minipage}
\\
...
\lstinputlisting[language=Python]{C:/Users/angus/OneDrive/Documents/CATAM 7.5/Question_5_end.py}
\vspace{2cm}
